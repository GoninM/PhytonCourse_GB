...
n = 4
print(f'make_order({n}) check test_cell_1({test_cell_1.num})')
print(test_cell_1.make_order(n))

n = 3
print(f'make_order({n}) check test_cell_2({test_cell_2.num})')
print(test_cell_2.make_order(n))
